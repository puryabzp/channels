...
from .models import Member, GroupChat,VideoThread
...
def main_page(request):
    return  HttpResponse('hoollllllaaaaaaaaaaaa !')
...
# async def forasync(request,val):
#     await asyncio.sleep(val)    
#     return HttpResponse(f'we wait for you for {val} sec')

def forasync(request,val):
    time.sleep(val)    
    return HttpResponse(f'we wait for you for {val} sec')    
