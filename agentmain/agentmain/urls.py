...
from multiplechat import views as chat_views
...
urlpatterns = [
    ...
    path('', chat_views.main_page, name = 'main_page'),
    path('chat/', include('websock.urls')),
    path('multiplechat/', include('multiplechat.urls')),
